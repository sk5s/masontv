...
<div class="w-screen h-screen flex flex-row">
  ...
  {#if channel}
    <div class="flex flex-col flex-1">
      ...
      {#if channel.type == "yt"}
          <iframe class="w-full h-full" width="560" height="315" src="https://www.youtube-nocookie.com/embed/{channel.videoId}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      {/if}
    </div>
  {/if}
</div>